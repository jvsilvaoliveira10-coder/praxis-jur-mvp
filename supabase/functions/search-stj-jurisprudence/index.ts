...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Use service role for RPC calls and data import
    ...
    console.error('Erro na busca STJ:', error instanceof Error ? error.message : error);
    return new Response(
      JSON.stringify({
        success: false,
        error: 'Erro interno na busca de jurisprudência',
      }),
