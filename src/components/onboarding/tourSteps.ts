...
export const TOUR_JURIDICO: TourStep[] = [
  {
    ...
    description: 'Seu painel com visão geral de tudo: prazos com countdown em tempo real, processos ativos e métricas do escritório.',
  ...
  },
  {
    ...
    description: 'Crie petições com 8 modelos especializados de IA (Habeas Corpus, Embargos, etc.) em poucos minutos.',
    icon: FileText,
    placement: 'right',
    module: 'juridico',
  },
  ...
  },
  {
    ...
    description: 'Receba notificações de prazos, movimentações e alertas urgentes por email automaticamente.',
    icon: Bell,
    placement: 'left',
    module: 'juridico',
  },
