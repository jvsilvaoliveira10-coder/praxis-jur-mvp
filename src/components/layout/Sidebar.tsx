  ...
  const categories: NavCategory[] = [
    {
      ...
      items: [
        ...
        { to: '/cases', icon: FolderOpen, label: 'Processos', tourId: 'cases' },
        ...
        { to: '/templates', icon: BookTemplate, label: 'Modelos', tourId: 'templates' },
        { to: '/jurisprudence', icon: Search, label: 'Jurisprudência', tourId: 'jurisprudence' },
        { to: '/tracking', icon: Radar, label: 'Acompanhamento', tourId: 'tracking' },
        { to: '/agenda', icon: CalendarDays, label: 'Agenda', tourId: 'agenda' },
    ...
    },
    {
      ...
      icon: Wallet,
      items: [
        { to: '/financeiro', icon: LayoutDashboard, label: 'Painel', tourId: 'finance-dashboard' },
        { to: '/financeiro/receber', icon: ArrowDownCircle, label: 'Contas a Receber', tourId: 'receivables' },
        { to: '/financeiro/pagar', icon: ArrowUpCircle, label: 'Contas a Pagar', tourId: 'payables' },
        { to: '/financeiro/extrato', icon: Receipt, label: 'Extrato', tourId: 'transactions' },
        { to: '/financeiro/contratos', icon: FileSignature, label: 'Contratos', tourId: 'contracts' },
        { to: '/financeiro/relatorios', icon: BarChart3, label: 'Relatórios', tourId: 'finance-reports' },
        { to: '/financeiro/config', icon: Settings, label: 'Configurações Fin.', tourId: 'finance-settings' },
      ],
    },
  ];
